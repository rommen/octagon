...
class CommentsController extends Controller {
     ...
     *
     * @Route("/", name="admin_comments_create")
     * @Method("POST")
     ...
     *
     * @Route("/new", name="admin_comments_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_comments_show")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_comments_edit")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_comments_update")
     * @Method("PUT")
