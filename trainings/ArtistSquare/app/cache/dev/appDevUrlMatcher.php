...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css/d2fea7c')) {
            // _assetic_d2fea7c
            if ($pathinfo === '/css/d2fea7c.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'd2fea7c',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_d2fea7c',);
            }

            // _assetic_d2fea7c_0
            if ($pathinfo === '/css/d2fea7c_part_1_gallery_1.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'd2fea7c',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_d2fea7c_0',);
            }
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'ArtistSquare\\ArtistBundle\\Controller\\HomeController::indexAction',  '_route' => '_home',);
        }

        if (0 === strpos($pathinfo, '/galleries')) {
            // _galleries
            if ($pathinfo === '/galleries') {
                return array (  '_controller' => 'ArtistSquare\\ArtistBundle\\Controller\\GalleryController::listAction',  '_route' => '_galleries',);
            }

            // _gallery
            if (preg_match('#^/galleries/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => '_gallery')), array (  '_controller' => 'ArtistSquare\\ArtistBundle\\Controller\\GalleryController::viewAction',));
            }
        ...
        // _about
        if ($pathinfo === '/about') {
            return array (  '_controller' => 'ArtistSquare\\ArtistBundle\\Controller\\AboutController::aboutAction',  '_route' => '_about',);
        }
