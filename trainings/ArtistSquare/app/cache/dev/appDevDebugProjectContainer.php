...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['assetic.filter.less'] = $instance = new \Assetic\Filter\LessFilter('/home/rommen/Symfony/node-v0.10.32-linux-x86/bin/node', array(0 => '/usr/local/lib/node_modules'));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e->addDriver($d, 'ArtistSquare\\ArtistBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('ArtistBundle' => 'ArtistSquare\\ArtistBundle\\Entity'));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'ArtistBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5478eb8a130be')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ArtistBundle' => 'ArtistSquare\\ArtistBundle\\ArtistBundle',
            ...
            'assetic.filter.less.node' => '/home/rommen/Symfony/node-v0.10.32-linux-x86/bin/node',
